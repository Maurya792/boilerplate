...
export class TeamCrudResolver {
  ...
  async aggregateTeam(
    ...
    @TypeGraphQL.Args() args: AggregateTeamArgs,
  ): Promise<AggregateTeam> {
  ...
  async createManyTeam(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyTeamArgs,
  ...
  async createOneTeam(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOneTeamArgs,
  ): Promise<Team> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteManyTeam(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyTeamArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneTeam(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOneTeamArgs,
  ): Promise<Team | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstTeam(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstTeamArgs,
  ): Promise<Team | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstTeamOrThrow(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstTeamOrThrowArgs,
  ): Promise<Team | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async teams(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyTeamArgs,
  ): Promise<Team[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async team(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueTeamArgs,
  ): Promise<Team | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getTeam(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueTeamOrThrowArgs,
  ): Promise<Team | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async groupByTeam(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByTeamArgs,
  ): Promise<TeamGroupBy[]> {
  ...
  async updateManyTeam(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyTeamArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOneTeam(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateOneTeamArgs,
  ): Promise<Team | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOneTeam(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOneTeamArgs,
  ): Promise<Team> {
    const { _count } = transformInfoIntoPrismaArgs(info);
