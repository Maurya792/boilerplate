...
export class PartCrudResolver {
  ...
  async aggregatePart(
    ...
    @TypeGraphQL.Args() args: AggregatePartArgs,
  ): Promise<AggregatePart> {
  ...
  async createManyPart(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyPartArgs,
  ...
  async createOnePart(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOnePartArgs,
  ): Promise<Part> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteManyPart(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyPartArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOnePart(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOnePartArgs,
  ): Promise<Part | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstPart(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstPartArgs,
  ): Promise<Part | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstPartOrThrow(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstPartOrThrowArgs,
  ): Promise<Part | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async parts(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyPartArgs,
  ): Promise<Part[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async part(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniquePartArgs,
  ): Promise<Part | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getPart(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniquePartOrThrowArgs,
  ): Promise<Part | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async groupByPart(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByPartArgs,
  ): Promise<PartGroupBy[]> {
  ...
  async updateManyPart(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyPartArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOnePart(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateOnePartArgs,
  ): Promise<Part | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOnePart(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOnePartArgs,
  ): Promise<Part> {
    const { _count } = transformInfoIntoPrismaArgs(info);
